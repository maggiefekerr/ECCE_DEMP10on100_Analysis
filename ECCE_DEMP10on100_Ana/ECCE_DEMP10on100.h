...
class ECCE_DEMP10on100 : public SubsysReco
{
 ...
 protected:
  ...
  //Double_t PmissCutValIP6[9] = {96.5, 96.5, 94.5, 92.5, 88.5, 85.5, 81.5, 77.5, 76.0}; // Array to store Pmiss cut values in - updated 07/25/2022 because of differences between IP6 and IP8 results
  Double_t PmissCutValIP6[9] = {97.5, 97.5, 95.5, 93.5, 89.0, 86.0, 83.0, 80.0, 79.0}; // cohesive cuts with IP8
  //Double_t PmissCutValIP8[9] = {96.5, 96.5, 94.5, 92.5, 88.5, 95.0, 92.0, 92.0, 88.0}; // Array to store Pmiss cut values in - updated 07//25/2022 because of differences between IP6 and IP8 results
  Double_t PmissCutValIP8[9] = {97.5, 97.5, 95.5, 93.5, 89.0, 86.0, 83.0, 80.0, 79.0}; // cohesive cuts with IP6
  Double_t Q2BinVal[10] = {2.0, 5.0, 7.5, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0}; // mfek 06/22/2022 - new binning
  ...
  TH1F* h1_t_Q2[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_t_alt_Q2[9]; // mfek 06/22/2022 - changed binning

  // 2D Kinematic analysis plots
  TH2F* h2_t_ep;
  TH2F* h2_t_Q2;
  TH2F* h2_delta_t_t;
  TH2F* h2_delta_t_t_Q2[9]; // mfek 06/22/2022 - changed binning
  ...
  TH1F* h1_t_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_t_result_uw[9]; // new unweighted version
  TH1F* h1_t_truth_thrown_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_t_truth_thrown_result_uw[9]; // new unweighted version
  TH1F* h1_nTheta_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_pmiss_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_pn_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_pn_result_uw[9];
  TH1F* h1_t_cut_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_t_cut_result_uw[9]; // new unweighetd version
  TH1F* h1_Q2_cut_result[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_W_cut_result[9]; // mfek 06/22/2022 - changed binning

  // 2D Physics Results Plots
  TH2F* h2_Q2_W_result;
  TH2F* h2_t_ttruth_result;
  TH2F* h2_t_alt_ttruth_result;
  TH2F* h2_t_ttruth_result_Q2[9]; // mfek 06/22/2022 - changed binning
  TH2F* h2_t_alt_ttruth_result_Q2[9]; // mfek 06/22/2022 - changed binning
  TH2F* h2_t_t_alt_result;
  TH2F* h2_Q2_t_result[9]; // mfek 06/22/2022 - changed binning
  TH2F* h2_Q2_Q2truth_result[9]; // mfek 07/21/2022
  TH2F* h2_W_Wtruth_result[9]; // mfek 07/21/2022
  ...
  TH1F* h1_t_Resolution[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_t_Abs_Resolution[9]; // absolute resolution
  TH1F* h1_talt_Resolution_ZDC[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_talt_Abs_Resolution_ZDC[9];
  TH1F* h1_talt_Resolution_pMiss[9]; // mfek 06/22/2022 - changed binning
  TH1F* h1_talt_Abs_Resolution_pMiss[9];

  TH1F* h1_Q2_Resolution[9]; // mfek 07/21/2022 - new Q2 resolution plots
  TH1F* h1_Q2_Abs_Resolution[9]; // absolute error
  TH1F* h1_Q2_Resolution_Overall; // mfek 07/21/2022 - new Q2 resolution plot
  TH1F* h1_W_Resolution[9]; // mfek 07/21/2022 - new W resolution plots
  TH1F* h1_W_Abs_Resolution[9]; // absolute error
  ...
  // counters for rate errors - mfek 07/20/2022

  Int_t ratesQ2[9]={0,0,0,0,0,0,0,0,0};
  Int_t ratesW[9]={0,0,0,0,0,0,0,0,0};
  
  Int_t rateErr002[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr006[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr010[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr014[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr018[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr022[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr026[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr030[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr034[9]={0,0,0,0,0,0,0,0,0};
  Int_t rateErr038[9]={0,0,0,0,0,0,0,0,0};

  Double_t tCuts[11] = {0.0, 0.04, 0.08, 0.12, 0.16, 0.20, 0.24, 0.28, 0.32, 0.36, 0.40};
};

  // initializers for weighting error print out
  Double_t weightinfo[150000][14];
  Int_t weightcounter;
